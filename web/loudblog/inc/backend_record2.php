...
if ($_GET['do'] == "browser") {
    if (isset($_GET['id'])){
		...
		echo "</br>";*/
		exec("mv /opt/swara/sounds/$edit_id.wav /opt/swara/sounds/original/$edit_id.wav");
		exec("/usr/local/bin/lame /opt/swara/web/audio/$edit_id.mp3 --decode /opt/swara/sounds/$edit_id.wav", $output = array(),$result);		
		exec("/usr/bin/sox -V /opt/swara/sounds/$edit_id.wav -r 8000 -c 1 /opt/swara/sounds/$edit_id.raw");
